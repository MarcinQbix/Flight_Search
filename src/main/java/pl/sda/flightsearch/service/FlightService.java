...
@Autowired
    ...
    public List<FlightDTO> showAllFlights(String flyFrom, String flyTo, LocalDate dateFrom, LocalDate dateTo) {
        ...
        return flights.stream()
                .map(b->new FlightDTO(b.getFlyTo(),b.getAirlines(),b.getFlyDuration(),b.getFlyFrom(), b.getDTimeUTC(), b.getBookingToken(),b.getCityFrom(), b.getCityTo(),b.getATimeUTC(),b.getPrice(),b.getBaglimit())).collect(Collectors.toList());
